...
import org.xtext.mydsl.formatting2.MyDslFormatter;
import org.xtext.mydsl.generator.MyDslGenerator;
import org.xtext.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.mydsl.parser.antlr.MyDslParser;
import org.xtext.mydsl.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.mydsl.scoping.MyDslScopeProvider;
import org.xtext.mydsl.serializer.MyDslSemanticSequencer;
import org.xtext.mydsl.serializer.MyDslSyntacticSequencer;
import org.xtext.mydsl.services.MyDslGrammarAccess;
import org.xtext.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import org.xtext.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.mydsl.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("mydsll");
	}
